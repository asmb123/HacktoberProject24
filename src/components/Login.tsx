...
const Login = () => {
  ...
  return (
        ...
        <div className="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-slate-300">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <h1 className="text-xl font-bold leading-tight tracking-tight text-black md:text-2xl ">
              {isRegistred ? "sign in to your account" : "create an account"}
            </h1>
            <form
    ...
    <button className="flex gap-2 items-center  dark:bg-gray-900 border hover:bg-white hover:text-black rounded-lg shadow-md px-6 py-2 text-sm font-medium  dark:text-white  focus:outline-none  ">
